...
build() {
    ...
    docker build -f /home/azure/Documents/Code/Hive/frontend/backend/services/login/Dockerfile -t $IMAGE_NAME /home/azure/Documents/Code/Hive/frontend/backend/services/login
